...
class ibex_core extends Module {
  ...
  alu.io.operand_b_i <> id_stage.io.alu_operand_b_ex_o
  ...
  lsu.io.read_req <> id_stage.io.lsu_req_o
  lsu.io.addr_o <> io.data_addr_o
  lsu.io.data_w_req <> io.data_w_req_o
  lsu.io.data_w_o <> io.data_w_o
  lsu.io.data_r_req <> io.data_r_req_o
  lsu.io.data_r_i <> io.data_r_i
  lsu.io.read_data_vaild <> io.read_data_vaild_i
